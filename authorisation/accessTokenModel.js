...
function getUser(username, password, callback) {
  ...
  logger.info('getUser() called and username is: ', username, ' and password is: ', password, ' and callback is: ', callback, ' and is userDBHelper null is: ', userDBHelper);
...
function saveAccessToken(accessToken, clientID, expires, user, callback) {
  ...
  accessTokensDBHelper.saveAccessToken(accessToken, user, callback);
}
...
function getAccessToken(params, callback) {
  ...
  callback(params.user_id == null ? true : false, params.user_id == null ? null : accessToken);
}
